...
%type <root> Declarations DeclList Decl VarList Type DECL ENDDECL INTEGER STRING STRING_LITERAL


%token NUM END _BEGIN READ WRITE ID IF then Else ENDIF WHILE DO ENDWHILE LT GT LE GE EQ NE BREAK CONT DECL ENDDECL INTEGER STRING STRING_LITERAL
